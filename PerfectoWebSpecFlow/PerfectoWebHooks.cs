...
namespace PerfectoSpecFlow
{
    ...
    public class PerfectoWebHooks
    {
		...
		protected static RemoteWebDriverExtended driver;
        ...
        private static ReportiumClient CreateReportingClient()
        {
            PerfectoExecutionContext perfectoExecutionContext = new PerfectoExecutionContext.PerfectoExecutionContextBuilder()
                .withProject(new Project("Specflow Web", "v1.0")) //optional 
                .withContextTags(new[] { "web", "specflow" }) //optional 
		...
		private static void CheckForValidDeviceConfiguration()
		{
			...
			if (CurrentDevice.DeviceDetails.RunNative)
				Assert.Inconclusive(string.Format("Native not supported in WebHooks"));
		}
